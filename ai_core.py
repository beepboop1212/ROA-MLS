...
#                 # NEW: Added mls_listing_id parameter
...
#     # The System Prompt is updated to include instructions for the new action
#     system_prompt = f"""
...
#     - **Use Case:** Use this INSTEAD of `MODIFY` if the user's initial prompt contains an MLS ID (e.g., "MLS 1234567", "post for 12400539").
#     - **The Workflow:**
...
#     - **CRITICAL `FETCH` RULE:** This action is a data-gathering step. Do not mention modifications yet.
...
#         {'role': 'model', 'parts': [f"Understood. I will strictly follow all Core Directives. My new priority is to use `FETCH_MLS_DATA` when an MLS ID is provided. I will otherwise behave as instructed."]}
#     ]
